...
public class PatientRegistration {
    ...
    public void beginRegistration() throws ClassNotFoundException, SQLException, IOException {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            patientBasicDetails.setFirstName(nametemp);
...
// update method to insert values in the database after user's choice is entered
    ...
    public void update() throws ClassNotFoundException, SQLException, IOException {
        try {
            ...
            System.out.println("Exception Encountered Moving to Main Menu");
            WelcomePage init = new WelcomePage();
            init.display();
        }
    }
