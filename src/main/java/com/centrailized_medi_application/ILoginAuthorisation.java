...
public interface ILoginAuthorisation {
  ...
  public String getSecurityQuestion(String Username);//will be used to get the security questions for the user trying to login

  public String resetPassword(String user_name, boolean securityQuesCleared, Integer retries);//This function will provide the user the ability to reset password
